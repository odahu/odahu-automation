pipeline {
    ...
    environment {
        ...
        //Job parameters
        azureCredentials = "AZURE_LEGN_CREDENTIALS"
    ...
    stages {
        ...
        stage('Create Legion Cluster') {
            ...
            steps {
                script {
                    legion.createCluster("${env.azureCredentials}", "--env-file ")
                }
            }
        }
        ...
        stage('Run regression tests') {
            ...
            steps {
                script {
                    legion.runRobotTests(env.param_tests_tags ?: "", "${env.azureCredentials}", "--env-file ")
                }
            }
        }
    }
