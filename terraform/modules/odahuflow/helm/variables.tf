...
variable "odahuflow_connections" {
  type        = any
  default     = []
  description = "Initial list of ODAHU flow connections (http://docs.odahu.epam.com/ref_connections.html)"
}
...
variable "opa_chart_version" {
  type        = string
  description = "Version of opa helm chart"
}
